...
export default function AddProjectPage() {
  ...
  const onSubmit = async (data: ProjectFormValues) => {
    ...
    try {
      ...
      if (!response.ok) {
         ...
         throw new Error(errorData.error?.message || t('errorCreateProject', {ns: 'adminProjects'}));
      }

      toast({
        title: t('common:success'),
        description: t('successCreateProject', {ns: 'adminProjects'}),
      });
      ...
      toast({
        title: t('common:error'),
        description: error instanceof Error ? error.message : t('errorCreateProject', {ns: 'adminProjects'}),
        variant: 'destructive',
      });
    } finally {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-6">{t('addProject', {ns: 'adminProjects'})}</h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={isSubmitting || isUploading}>
              {isSubmitting ? t('creating', {ns: 'adminProjects'}) : t('create', {ns: 'adminProjects'})}
            </Button>
          </div>
        </form>
      </Form>
